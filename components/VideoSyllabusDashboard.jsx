          ...
          <View style={styles.cardBody}>
            ...
            <View style={styles.infoContainer}>
              <View style={styles.infoRow}>
                ...
                <Text style={styles.infoValue}>{item.duration || 'N/A'}</Text>
              </View>
              ...
              {item.updatedAt && item.updatedAt !== item.createdAt && (
                <View style={styles.infoRow}>
                  <View style={styles.iconCircle}>
                    <Icon name="update" size={14} color="#1a3b5d" />
                  </View>
        ...
        >
          ...
          >
            ...
            <Text style={styles.purchaseButtonText}>
              {(item.fees === 0 || item.fees === '0') ? 'Get Free Video' : 'Purchase Video'}
            </Text>
          </LinearGradient>
        </TouchableOpacity>
      </View>
  ...
  if (isLoading) {
    return (
      <View style={styles.centerContainer}>
        ...
        <Text style={styles.loadingText}>Loading video materials...</Text>
      </View>
    );
  }
    ...
    <View style={styles.container}>
      ...
      >
        <View style={styles.headerContent}>
          <View>
            <Text style={styles.headerTitle}>Video Materials</Text>
            <Text style={styles.headerSubtitle}>
              {filteredSyllabi.length} video{filteredSyllabi.length !== 1 ? 's' : ''} available
            </Text>
          </View>
          <TouchableOpacity
            ...
            onPress={() => {
              if (navigation && typeof navigation.navigate === 'function') {
                navigation.navigate('VideoSyllabusEntry');
              } else {
          ...
          >
            ...
            <Text style={styles.myMaterialsButtonText}>My Videos</Text>
          </TouchableOpacity>
        </View>
      </LinearGradient>
      ...
      {/* Video Syllabus Cards List */}
      {filteredSyllabi.length === 0 ? (
        <View style={styles.emptyContainer}>
          <Icon name="videocam" size={90} color="#ddd" />
          <Text style={styles.emptyText}>No video study materials found</Text>
