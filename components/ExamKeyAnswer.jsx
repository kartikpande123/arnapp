...
const ExamKeyAnswer = () => {
  ...
  const handleOpenLink = async (url) => {
    try {
      ...
      // If it's a Google Drive link, ensure it's in view format
      ...
      if (canOpen) {
        ...
        // Fallback: try to open in browser with http/https
  ...
  const handleDownload = async (url) => {
    try {
      ...
      if (canOpen) {
        ...
        // Fallback: open the view link instead
    ...
    <View style={styles.card}>
      ...
      <View style={styles.actionContainer}>
        <TouchableOpacity
          ...
          onPress={() => handleOpenLink(item.qaLink)}
          activeOpacity={0.7}
        >
          <Text style={styles.buttonIcon}>🔗</Text>
          <Text style={styles.primaryButtonText}>View Q&A</Text>
        </TouchableOpacity>

        <TouchableOpacity
          style={styles.secondaryButton}
          onPress={() => handleDownload(item.qaLink)}
          activeOpacity={0.7}
        >
  ...
  const renderEmpty = () => (
    <View style={styles.emptyContainer}>
      ...
      <Text style={styles.emptyTitle}>No Q&A documents available</Text>
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>Exam Q&A</Text>
        </View>
    ...
    return (
      <View style={styles.container}>
        ...
        <View style={styles.errorContainer}>
          ...
          <TouchableOpacity style={styles.retryButton} onPress={fetchQAData}>
    ...
    <View style={styles.container}>
      ...
      <View style={styles.footer}>
        <Text style={styles.footerText}>
          💡 Click "View Q&A" to open in browser or download icon to save
        </Text>
      </View>
    </View>
  );
