...
const PdfSyllabusPurchase = ({ route, navigation }) => {
  // Get selected syllabus from navigation params
      ...
      <html>
        ...
        <body>
          <div class="header">
            ...
            <h1>ARN PDF SYLLABUS PURCHASE</h1>
          </div>
          ...
          <div class="content">
            ...
            <div class="syllabus-section">
              <div class="syllabus-title">Syllabus Details</div>
              ...
              <div style="margin-top: 10px;">
                <div class="syllabus-detail-label">Expires On</div>
            ...
            <div class="instructions">
              <ul>
                <li>Once a syllabus is purchased, it is non-refundable under any circumstances.</li>
                <li>With your Student ID, you may purchase any syllabus without completing additional forms.</li>
                <li>Access to the syllabus will be automatically revoked after the expiration date.</li>
            ...
            <div class="footer">
              <div class="footer-text">
                ...
                © 2025/26 ARN PDF SYLLABUS. All rights reserved.
              </div>
            </div>
          </div>
        </body>
        ...
        <body>
          ...
          <div class="logo-section">
            ...
            <div class="company-info">
              <div class="company-name">ARN PDF Syllabus Distribution</div>
      ...
      purchasedStudentDetails.state || 'N/A'
          ...
          <div class="table-content">
            <div class="description-text">
              <strong>PDF Syllabus:</strong> ${selectedSyllabus.title}
            </div>
            <div class="description-text">
  ...
  const handleStudentIdVerification = async () => {
    ...
    try {
      const response = await axios.get(
        `${API_BASE_URL}/api/pdf-verify-student/${studentId}`,
      );
      ...
      if (response.data.exists) {
        ...
        const purchasesResponse = await axios.get(
          `${API_BASE_URL}/api/pdf-student-purchases/${studentId}`,
        );
  ...
  // Register or update student after payment
    ...
    try {
      ...
      if (isNewStudent) {
        ...
        const response = await axios.post(
          `${API_BASE_URL}/api/pdf-register-student`,
          studentData,
        );
  ...
  const createOrder = async () => {
    try {
      ...
      const response = await axios.post(
        `${API_BASE_URL}/api/create-pdf-order`,
        {
          amount: price,
          notes: {
  ...
  const verifyPayment = async paymentData => {
    try {
      const response = await axios.post(
        `${API_BASE_URL}/api/verify-pdf-payment`,
        {
  ...
  const savePurchaseDetails = async (paymentVerified, studentId) => {
    try {
      ...
      const response = await axios.post(
        `${API_BASE_URL}/api/pdf-save-syllabus-purchase`,
        {
          studentId: studentId,
          syllabusDetails: {
  ...
  const handleSyllabusPurchase = async () => {
    ...
    try {
      ...
      if (isFree) {
        ...
        Alert.alert('Success', 'Free syllabus added to your account!');
      } else {
  ...
  const handleBackToHome = () => {
    navigation.navigate('PdfSyllabusDashboard');
  };
        ...
        return (
          <View style={styles.stageContainer}>
            <View style={styles.card}>
              <View style={styles.cardHeader}>
                <Text style={styles.cardHeaderText}>
                  PDF Syllabus Purchase Confirmation
                </Text>
              </View>
              <View style={styles.cardBody}>
                ...
                <View style={styles.detailsBox}>
                  ...
                  <Text style={styles.descriptionText}>
                    {selectedSyllabus?.description ||
                      'Comprehensive PDF syllabus for exam preparation.'}
                  </Text>
                </View>
                ...
                <View>
                  ...
                  <View style={styles.successBox}>
                    ...
                    <Text style={styles.successText}>
                      You can now access this PDF syllabus in your dashboard.
                    </Text>
                  </View>
                </View>
              )}
...
export default PdfSyllabusPurchase;
